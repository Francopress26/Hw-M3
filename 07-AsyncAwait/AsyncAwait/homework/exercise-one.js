...
async function problemA () {
  ...
  await promisifiedReadFile('poem-one/stanza-01.txt')
  .then(file=> console.log(blue(file)))
...
function problemB () {
  ...
  // AsyncAwait version
  async function RF(){
    await promisifiedReadFile('poem-one/stanza-02.txt')
    .then(file=>console.log(blue(file)))

   await promisifiedReadFile('poem-one/stanza-03.txt')
    .then(file=>console.log(blue(file)))
  }
  RF()
}
